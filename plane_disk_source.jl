...
function lensing_plots(D_s, D_d, D_ds, R_s; eta_tilde_min, eta_tilde_max, neta_tilde, nphi)
    ...
    # Uniformly Distributed Sources in a Plane Disk
    ...
    savefig(p, "source_plane_disk.png")
    savefig(q, "source_plane_disk_image.png")
...
lensing_plots(D_s, D_d, D_ds, R_s; eta_tilde_min = 0.0, eta_tilde_max = 3.0,
